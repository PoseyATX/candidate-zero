...
| A5 | **You can cut a card you just practised.** Soft caution on the cut (button + log); cut still legal — practised cards return to the deck. | §10 | DONE |
...
| B6 | **The session catalog rewards spamming one card.** SS27 Ribbon-Cutting Circuit now decays odds and payoff with circuits (same truth rule as SS12) — the face no longer advertises "never diminishes." | DONE |
